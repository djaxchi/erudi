...
```bash
curl http://localhost:8000/erudi/knowledge_base/jobs/1
```
...
```bash
curl -X DELETE http://localhost:8000/erudi/knowledge_base/1
```
...
```bash
# Nombre de chunks
curl http://localhost:8000/erudi/knowledge_base/1
