...
class TestPromptUtils:
    ...
    def test_build_system_prompt_tiny(self):
        ...
        """
        prompt = build_system_prompt(model_name="Test Tiny 1B", size_category="tiny")
    ...
    def test_build_system_prompt_small(self):
        ...
        """
        prompt = build_system_prompt(model_name="Test Small 2B", size_category="small")
    ...
    def test_build_system_prompt_medium(self):
        ...
        """
        prompt = build_system_prompt(model_name="Mistral 7B", size_category="medium")
    ...
    def test_build_system_prompt_large(self):
        ...
        prompt = build_system_prompt(model_name="Mistral Nemo 12B", size_category="large")
    ...
    def test_build_system_prompt_xlarge_aligns_on_large(self):
        ...
        xlarge = build_system_prompt(model_name="Test XLarge 20B", size_category="xlarge")
        large = build_system_prompt(model_name="Other Model 12B", size_category="large")
    ...
    def test_build_system_prompt_with_starred_messages(self):
        ...
        """
        starred = ["Always use type hints in Python", "Remember to handle exceptions properly"]

        prompt = build_system_prompt(
            model_name="Test 7B", size_category="medium", starred_messages=starred
        )
    ...
    def test_kb_token_budget_scales_monotonically(self):
        ...
        budgets = [
            get_prompting_strategy(param_size=size)["kb_token_budget"] for size in (1, 3, 7, 12, 20)
        ]
...
class TestHFMetadataUtils:
    ...
    def test_format_model_info_metadata_basic(self):
        ...
        metadata = format_model_info_metadata(
            model_info=mock_model_info, size_estimate=size, quantized=True
        )
    ...
    def test_format_model_info_metadata_no_estimate(self):
        ...
        metadata = format_model_info_metadata(model_info=mock_model_info)
...
class TestUtilsIntegration:
    ...
    def test_prompt_strategy_consistency(self):
        ...
        for size in test_sizes:
            ...
            prompt = build_system_prompt(model_name=f"Test {size}B", size_category=category)
