...
class TestHardwareService:
    ...
    def test_get_or_create_profile_returns_cached_when_backend_matches(
    ...
    def test_get_or_create_profile_reprofiles_when_version_is_null(self, service, mock_repository):
...
class TestRecommendedParamRange:
    ...
    def test_cuda_5060ti_is_memory_bound(self):
        ...
        profile = self._profile(backend_type="cuda", vram_total_gb=16.0, memory_bandwidth_gbs=448.0)
    ...
    def test_cuda_48gb_is_memory_bound_and_floor_is_capped(self):
        ...
        profile = self._profile(backend_type="cuda", vram_total_gb=48.0, memory_bandwidth_gbs=900.0)
    ...
    def test_cuda_slow_memory_is_bandwidth_bound(self):
        ...
        profile = self._profile(backend_type="cuda", vram_total_gb=16.0, memory_bandwidth_gbs=200.0)
    ...
    def test_unknown_bandwidth_falls_back_to_capacity_only(self):
        ...
        profile = self._profile(backend_type="cpu", total_memory_gb=16.0, memory_bandwidth_gbs=None)
    ...
    def test_zero_bandwidth_is_treated_as_unknown(self):
        ...
        profile = self._profile(backend_type="cpu", total_memory_gb=16.0, memory_bandwidth_gbs=0.0)
        assert recommended_param_range(profile) == (5.4, 10.8)
    ...
    def test_cpu_small_laptop(self):
        ...
        profile = self._profile(backend_type="cpu", total_memory_gb=8.0, memory_bandwidth_gbs=50.0)
    ...
    def test_min_never_exceeds_max(self):
        ...
        profile = self._profile(backend_type="cuda", vram_total_gb=16.0, memory_bandwidth_gbs=10.0)
        min_p, max_p = recommended_param_range(profile)
        assert min_p <= max_p
    ...
    def test_ceiling_is_capped(self):
        ...
        profile = self._profile(
            backend_type="cuda", vram_total_gb=1000.0, memory_bandwidth_gbs=10000.0
        )
